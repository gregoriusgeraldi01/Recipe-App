...
struct EbookView: View {
    var body: some View {
        ...
        NavigationView{
            ...
            Home()
            .navigationBarTitle("EBooks For Cooking")
        }
    }
}
...
struct Home : View {
    ...
    @State var url = "https://www.googleapis.com/books/v1/volumes?q=recipe+book"
...
class getData : ObservableObject{
    ...
    init() {
        ...
        let url = "https://www.googleapis.com/books/v1/volumes?q=recipe+book"
